...
- The CommandHandler orchestrates the process of handling a command, applying the decider, evolving the state, saving the new state, and returns a Result (events or validation errors)
